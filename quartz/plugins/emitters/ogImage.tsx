  ...
  return {
    ...
    async *emit(ctx, content, _resources) {
      ...
      if (!fonts || fonts.length === 0) {
        console.warn("[CustomOgImages] Using full embedded Inter fallback font...")
        const interBase64 = `
`
        `.replace(/\s+/g, "")
